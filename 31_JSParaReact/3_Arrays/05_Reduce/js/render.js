/**
 * Renderiza en el navegador el listado de películas que se le pasan como argumento
 * @param {Array<number>} list lista de id's de películas a renderizar
 * @param {Map} map Mapa de todas las películas disponibles
 */
